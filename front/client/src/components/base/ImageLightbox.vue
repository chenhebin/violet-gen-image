    ...
    <Transition name="lightbox">
      ...
      >
        <header>
          ...
          <button ref="closeButton" type="button" aria-label="关闭图片预览" @click="emit('close')">
            <X :size="22" />
          </button>
        </header>
        ...
        <div class="image-stage" @mousedown.self="emit('close')">
          <img
...
button:hover,
button:focus-visible { background: rgb(255 255 255 / 16%); }
...
@media (max-width: 600px) {
  ...
  .nav-button { top: auto; bottom: calc(18px + env(safe-area-inset-bottom)); }
